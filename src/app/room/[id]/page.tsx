...
export default function SessionRoomPage() {
  ...
  const [chatMessages, setChatMessages] = useState([
    { sender: peerName, text: `Hey ${user.name}! Can you help me out with this roadblock?`, time: '14:02' },
    { sender: user.name, text: 'Hey! Absolutely, let me diagnose the issue and write out the steps on the scratchpad.', time: '14:03' }
  ]);
