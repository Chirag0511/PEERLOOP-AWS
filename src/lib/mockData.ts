...
export const SHOWCASE_SQL_SOS_QUESTION: SOSRequest = {
  ...
  topic: 'SQL query command to show full "students" database table',
  description: 'In our database lab evaluation, we created the students table with columns id, name, department, campus_credits. Which SQL command is used to retrieve and display the complete table with all rows and columns?',
  category: 'Tech & Code',
  urgency: 'Critical (Exam/Deadline)',
  creditsReward: 1,
  bountyInRupees: 150,
